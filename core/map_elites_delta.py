...
from core.containers.mapelites_delta_repertoire import MapElitesDeltaRepertoire
from core.sampling import multi_sample_scoring_function


class MAPElitesDelta(MAPElites):
    ...
    def __init__(
        ...
        emitter: Emitter,
        metrics_function: Callable[[MapElitesDeltaRepertoire], Metrics],
        num_samples: int,
    ...
    def init(
        ...
        centroids: Centroid,
        random_key: RNGKey,
    ) -> Tuple[MapElitesDeltaRepertoire, Optional[EmitterState], RNGKey]:
        ...
        # init the repertoire
        repertoire = MapElitesDeltaRepertoire.init(
            genotypes=genotypes,
            fitnesses=fitnesses,
    ...
    def update(
        self,
        repertoire: MapElitesDeltaRepertoire,
        emitter_state: Optional[EmitterState],
        random_key: RNGKey,
    ) -> Tuple[MapElitesDeltaRepertoire, Optional[EmitterState], Metrics, RNGKey]:
        """
